...
<div class='fixed-top'>
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/">ShowUp<span class="flashy">.rocks</span></a>
    ...
    @endif               
        ...
        <li><button class="btn btn-default navbar-search" id="toggler"><i class="glyphicon glyphicon-search"></i></button></li>
